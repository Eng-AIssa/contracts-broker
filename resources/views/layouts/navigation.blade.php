            ...
            <div class="flex">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown2 align="left" width="48">
                        <x-slot name="trigger">
                            <x-nav-link2 class="pointer" :active="request()->routeIs('contract.*')">
                                {{ __('Contracts') }}
                            </x-nav-link2>
                        </x-slot>

                        <x-slot name="content">
                            <x-dropdown-link :href="route('contract.create')">
                                {{ __('Create') }}
                            </x-dropdown-link>

                            <x-dropdown-link :href="route('contract.index')">
                                {{ __('List') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown2>
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown2 align="left" width="48">
                        <x-slot name="trigger">
                            <x-nav-link2 class="pointer" :active="request()->routeIs('owner.*')">
                                {{ __('Owners') }}
                            </x-nav-link2>
                        </x-slot>

                        <x-slot name="content">
                            <x-dropdown-link :href="route('owner.create')">
                                {{ __('Create') }}
                            </x-dropdown-link>

                            <x-dropdown-link :href="route('owner.index')">
                                {{ __('List') }}
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown2>
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown2 align="left" width="48">
                        <x-slot name="trigger">
                            <x-nav-link2 class="pointer" :active="request()->routeIs('sector.*')">
                                {{ __('Sectors') }}
                            </x-nav-link2>
                        </x-slot>

                        <x-slot name="content">
                            <x-dropdown-link :href="route('sector.create')">
                                {{ __('Create') }}
                            </x-dropdown-link>
